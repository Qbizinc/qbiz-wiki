...
- A standardized, reliable process to performance test data applications and 
...
- A standardized, reliable process to leverage the results to determine recommendations for iteratively optimizing the application (rearchitecting, replatforming, etc.)
