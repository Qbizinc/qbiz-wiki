...
- A standardized, reliable process to performance test data applications and leverage the results to determine recommendations for iteratively optimizing the application (rearchitecting, replatforming, etc.)
